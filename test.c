...
void test_bin_to_dec(void) {
  ...
  // 101011110110
  // 0x10,0x10,0x11,0x11,0x01,0x10
  base_convert((uint8_t[]){0x10, 0x10, 0x11, 0x11, 0x01, 0x10}, 6, result,
               sizeof(result), 2, 10);
...
void test_hex_to_dec(void) {
  ...
  base_convert((uint8_t[]){0x8f, 0xc8, 0xe7, 0xf7, 0x8e, 0xfe}, 6, result,
               sizeof(result), 16, 10);
  ...
  // 0x12,0x23,0x24,0x4d,0x23,0x23,0x43,0x43,0x44,0x55,0x44,0x54,
  // 0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x45,0x54,0x54,0x54
  base_convert((uint8_t[]){0x12, 0x23, 0x24, 0x4d, 0x23, 0x23, 0x43,
                           0x43, 0x44, 0x55, 0x44, 0x54, 0x45, 0x45,
                           0x45, 0x45, 0x45, 0x45, 0x45, 0x45, 0x45,
                           0x45, 0x45, 0x45, 0x54, 0x54, 0x54},
               27, result, sizeof(result), 16, 10);
